...
<html>
  ...
  <div class="container-fluid">
    ...
    <!--End Nav Bar -->
		<main>
			<h2>Select a Personal Record to Edit:</h2>
			<p><a href="homepage.php">Back</a></p>
			<table>
				<tr>
					<td><a href ="user_user_edit.php">Change Your Personal information</a></td>
					<td><a href ="edit_password.php">Change Your Password</a></td>
				</tr>
			</table>
		</main>
