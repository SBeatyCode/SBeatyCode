...
<html>
  ...
  <div class="container-fluid">
    ...
    <!--End Nav Bar -->
		<h2 style="text-align: center;">Update Your Vehicle's Information</h2>
		<form action ="user_vehicle_editing.php" method="post">
		<main>
					...
					if(isset($_POST['submit'])) {
						...
						if($valid) {
							...
							if($db_connect->query($sql_update_query) === TRUE) {
								echo "Vehicle Information has been updated!<br>";
