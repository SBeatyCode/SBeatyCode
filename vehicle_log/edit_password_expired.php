...
<html>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li><a href="change_pw_help.php">Help</a></li>
    </ul>
    ...
    <!--End Nav Bar -->
		...
		<main>
			<form action ="edit_password_expired.php" method="post">
					...
					if(notEmptyOrNull($_POST['new_password'])) {
						if(isLength20($_POST['new_password'])) {
							if($_POST['new_password'] != $_POST['old_password']) {
								...
								echo '<p style="color: red">Your new password cannot be the same as your old password! Please enter something else!</p>';
							}
						} else {
